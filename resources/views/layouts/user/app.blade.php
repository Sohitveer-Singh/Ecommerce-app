...
<header id="header" class="header">
            ...
            <div class="header-center">
                ...
                <div class="header-cart-items">
                            ...
                            <div class="modal-main">
                                ...
                                <div class="wrapper-main">
                                    <div class="search-section">
                                        ...
                                        <a href="become-vendor#" class="shop-btn">Search</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="header-compaire">
                        {{--                        <a href="compaire" class="cart-item">--}}
                        {{--                                    <span>--}}
                    ...
                    <div class="header-favourite">
                        <a href="wishlist" class="cart-item">
                                    <span>
                    ...
                    {{--                                            <img--}}
                    {{--                                                src="{{ asset('assets/images/homepage-one/product-img/product-img-1.webp') }}"--}}
                    {{--                                                alt="img">--}}
                    {{--                                        </div>--}}
                    ...
                    {{--                                        <div class="wrapper-img">--}}
                    {{--                                            <img--}}
                    {{--                                                src="{{ asset('assets/images/homepage-one/product-img/product-img-2.webp') }}"--}}
                    {{--                                                alt="img">--}}
                    {{--                                        </div>--}}
                    {{--                                        <div class="wrapper-content">--}}
                    ...
                    {{--                                </div>--}}
                    {{--                                <div class="cart-btn">--}}
                    {{--                                    <a href="cart" class="shop-btn view-btn">View Cart</a>--}}
                    {{--                                    <a href="checkout" class="shop-btn checkout-btn">Checkout Now</a>--}}
                    {{--                                </div>--}}
                    {{--                            </div>--}}
                    {{--                        </div>--}}
                    {{--                    </div>--}}
    ...
    <nav class="mobile-menu d-block d-lg-none">
        <div class="mobile-menu-header d-flex justify-content-between align-items-center">
            ...
            <a href="index" class="mobile-header-logo">
            ...
            <div class="header-nav">
                <div class="category-menu-section position-relative">
                    ...
                    <div class="category-dropdown position-absolute" id="subMenu">
                        <ul class="category-list">
                            ...
                            {{--                                                            <rect x="1.5" y="0.818359" width="5.78538"--}}
                            {{--                                                                  height="1.28564" transform="rotate(45 1.5 0.818359)"--}}
                            {{--                                                                  fill="#1D1D1D"/>--}}
                ...
                <div class="header-nav-menu">
                    <ul class="menu-list">
                        ...
                        {{--Membership--}}
                        <li class="mega-menu">
                            <a href="{{route('public.memberships')}}">
                                <span class="list-text">Membership</span>
                                <span>
                ...
                <div class="header-vendor-btn">
                    @auth
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button href="{{route('login')}}" class="shop-btn">
                                <span class="list-text shop-text">Logout</span>
                                <span class="icon">
