                    ...
                    <div class="col-lg-7 order-lg-2">
                        <div class="question-section login-section">
                            <div class="review-form">
                                ...
                                <p class="d-none d-lg-block paragraph pb-5 text-center">Provide the essential information
                                    about your
                                    business so we can display accurate details to your customers.</p>
                                <form action="{{ route('vendor.listing.basic-details.store') }}" method="POST">
                                    @csrf
                                    <div class="row g-4">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <textarea name="description" class="input-basic textarea" rows="3" placeholder="Write Message..." required></textarea>
                                        </div>
