                ...
                <div class="row g-3 gy-5">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="sidebar-card step-card">
                            ...
                            <a href="{{ route('user.listing.basic-details.edit', $listing) }}" class="label">Edit Basic Details</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="sidebar-card step-card">
                            ...
                            <a href="{{ route('user.listing.address.edit', $listing) }}" class="label">Edit Address</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="sidebar-card step-card">
                            ...
                            <a href="{{ route('user.listing.timing.edit', $listing) }}" class="label">Edit Timings</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="sidebar-card step-card">
                            ...
                            <a href="{{ route('user.listing.amenities.edit', $listing) }}" class="label">Edit Amenities</a>
                        </div>
                    </div>
