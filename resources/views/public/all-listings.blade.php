            ...
            <div class="row g-5">
                ...
                <div class="col-lg-9 order-2 order-lg-1">
                    @foreach($listings as $listing)
                        <div class="border mb-5 bg-white rounded-4">
                            <div class="d-flex flex-row m-5 ">
                                <div style="height: 180px; width:180px;">
                                    <a href="{{route('public.listing-details',$listing)}}">
                                        <img class="h-100 w-100 rounded-3" src="{{$listing->thumbnail_url}}"
                                             alt="{{$listing->name}}">
                                    </a>
                                </div>
                                <div class="ms-5 ">
                                    <div class="mb-3">
                                        <a href="{{route('public.listing-details',$listing)}}">
                                        <span style="font-size: 1.9rem;" class="fw-normal">
                                            {{$listing->name}}
                                        </span>
                                        </a>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <span style="font-size: 1.5rem;" class="fw-normal">
...
{{--                                    </div>--}}
                                    <div class="mb-3">
                                        <span style="font-size: 1.4rem;" class="fw-normal">
                                            @if ($listing->today)

                                                @if (!$listing->today->is_closed)
                                                    <span style="font-size: 1.4rem;" class="text-success">Open  </span>
                                                    <span>until {{ $listing->today->close_time }}</span>
                                                @else
                                                    <span class="text-danger">Closed</span>
                                                @endif
                                            @else
                                                <span class="text-secondary">Timings not available.</span>
                                            @endif
                                    ...
                                    <div class="mb-3 ">
                                        ...
                                        <span style="font-size: 1.4rem; background: #2ef99f"
                                              class="fw-normal p-2 rounded-3">
                                            {{$listing->mobile}}
                                        </span>

                                        <a href="https://wa.me/{{$listing->whatsapp_no}}?text=Hi%20{{$listing->contact_person}}"
                                           style="font-size: 1.4rem; background: #2ef99f"
                                           class="fw-normal p-2 rounded-3 ms-3">
                                            WhatsApp
                                        </a>
                    ...
                    {{--                                            <a href="product-sidebar#" class="cart cart-item">--}}
                    {{--                                                <span>--}}
                    ...
                    {{--                                            <a href="product-info" class="product-details">--}}
                    {{--                                                {{$listing->name}}--}}
                    {{--                                            </a>--}}
                    {{--                                            <div class="price">--}}
                    {{--                                                <span class="price-cut">$</span>--}}
                    {{--                                                <span class="new-price">{{$listing->fullAddress}}</span>--}}
                    {{--                                            </div>--}}
                    {{--                                        </div>--}}
                    {{--                                    </div>--}}
                    {{--                                </div>--}}
                ...
                <div class="col-lg-3 order-1 order-lg-2">
                    <div class="sidebar" data-aos="fade-right">
                        <div class="sidebar-section">
                            ...
                            <form action="{{ route('public.listings.all') }}" method="GET">
                                <div class="sidebar-wrapper">
                                    <h5 class="wrapper-heading">Search Filters</h5>
                                    <div class="sidebar-item">
                                        ...
                                        <div class="py-4">
                                            <select id="tags" name="tags[]" class="form-select select2"
                                                    multiple="multiple">
                                                <option></option> @foreach ($tags as $tag)
                                                    <option value="{{ $tag->id }}"
                                                            {{-- Repopulate selected values --}}
                                        ...
                                        <div class="pb-4">
                                            <select class="form-select fs-4 py-4"
                                                    style="border: 1px solid #aaaaaa; color: #787878;" name="radius"
                                                    id="radius">
                                                <option value="">Distance from location</option>
                                                <option value="10" @selected($selectedRadius == 10)>Within 10 Km
                                                </option>
                                                <option value="30" @selected($selectedRadius == 30)>Within 30 Km
                                                </option>
                                                <option value="50" @selected($selectedRadius == 50)>Within 50 Km
                                                </option>
                                                <option value="100" @selected($selectedRadius == 100)>Within 100 Km
                                                </option>
                                                <option value="150" @selected($selectedRadius == 150)>Within 150 Km
                                                </option>
                                                <option value="300" @selected($selectedRadius == 300)>Within 300 Km
                                                </option>
                                            </select>
                                        </div>

                                        <button type="submit" style="margin: 0;border-radius: 4px"
                                                class="shop-btn w-100 py-4">
                                            <span>Search</span>
                                        </button>
                ...
                {{--                                                style="border: 1px solid #aaaaaa; color: #787878;" name="radius"--}}
                {{--                                                id="radius">--}}
                {{--                                            <option value="500">Distance from location</option>--}}
                ...
                {{--                                    <button href="#" style="margin: 0;border-radius: 4px"--}}
                {{--                                            class="shop-btn w-100 py-4">--}}
