...
@section('content')
    ...
    <section class="product-category">
        <div class="container">
            <div class="section-title">
                ...
                <a href="{{route('public.listings.categories')}}" class="view">View All</a>
            </div>
            <div class="category-section">
                @foreach($categories as $category)
                        <div class="product-wrapper" data-aos="fade-right"
                             data-aos-duration="{{100 * $loop->iteration }}">
                            <a class="w-100 h-100 d-flex justify-content-center align-items-center flex-column" href="{{route('public.listings.by_category',$category)}}">
                            <div class="wrapper-img">
                                <img src="{{$category->thumbnail_url}}" loading="lazy" alt="dress">
                            </div>
                            <div class="wrapper-info">
    ...
    <section class="product">
        <div class="container">
            <div class="section-title">
                ...
                <a href="{{route('public.listings.all')}}" class="view">View All</a>
            </div>
                            ...
                            <a href="{{ route('public.listing-details', $listing) }}" class="product-details">
                                ...
                                <div class="product-wrapper" data-aos="fade-up">
                                    <div class="product-img">
                                        ...
                                        <img src="{{ $listing->thumbnail_url }}" loading="lazy" alt="{{ $listing->name }}">
            ...
            <div class="category-section">
                @foreach ($categoriesWithListing as $category)
                    <a href="{{ route('public.listings.by_category', $category) }}">
                        <div style="gap: 6px" class="product-wrapper" data-aos="fade-right" data-aos-duration="100">
                            <div style="height: 120px;max-height: 120px;" class="wrapper-img">
                                @if ($category->coverListing)
                                    <img height="120px" loading="lazy" src="{{ $category->coverListing->thumbnail_url }}" alt="{{ $category->name }}">
                                @else
                                    <img height="120px"
                                         loading="lazy"
    ...
    <section class="product-category py-5 my-5">
        <div class="container">
            <div class="row g-4">
                                                ...
                                                <div class=" h-100  border-0 text-center ">
                                                    ...
                                                    @if ($category->coverListing)
                                                        <img src="{{ $category->coverListing->thumbnail_url }}"
                                                             loading="lazy"
                                                             class="card-img-top" height="130px" style="border-radius: 12px"
                                                             alt="{{ $category->name }}">
                                                    @else
                                                        <img
                                                            loading="lazy"
    ...
    <!--------------- flash-section--------------->
    <section class="product best-product pt-1">
        <div class="container">
            <div class="section-title">
