                            ...
                            <div class=" overflow-hidden border-0"
                                ...
                                <div style="height: 100px" class="d-flex align-items-center justify-center p-3">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <h5 class="mb-0">{{$completedListings}}</h5>
                                    </div>
                            ...
                            <div class=" overflow-hidden border-0"
                                ...
                                <div style="height: 100px" class="d-flex align-items-center justify-center p-3">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <h5 class="mb-0">{{$pendingListings}}</h5>
                                    </div>
                            ...
                            <div class=" overflow-hidden border-0"
                                ...
                                <div style="height: 100px" class="d-flex align-items-center justify-center p-3">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <h5 class="mb-0">{{$totalListings}}</h5>
                                    </div>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            ...
                            <div class=" overflow-hidden border-0"
                                ...
                                <div style="height: 100px" class="d-flex align-items-center justify-center p-3">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <p class="text-muted mb-1">User Count</p>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            ...
                            <div class=" overflow-hidden border-0"
                                ...
                                <div style="height: 100px" class="d-flex align-items-center justify-center p-3">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <p class="text-muted mb-1">Product Count</p>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            ...
                            <div class=" overflow-hidden border-0"
                                ...
                                <div style="height: 100px" class="d-flex align-items-center justify-center p-3">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <p class="text-muted mb-1">Joined Today</p>
                                        <h5 class="mb-0">{{$joinedToday}}</h5>
                                    </div>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            ...
                            <div class=" overflow-hidden border-0"
                                ...
                                <div style="height: 100px" class="d-flex align-items-center justify-center p-3">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <p class="text-muted mb-1">Joined Monthly</p>
                                        <h5 class="mb-0">{{$joinedMonth}}</h5>
                                    </div>
