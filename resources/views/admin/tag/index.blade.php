                        ...
                        <div class="tab-pane fade show active" id="v-pills-order" role="tabpanel"
                            ...
                            <div class="user-profile">
                                ...
                                <div class="profile-section">
                                    <div class="row g-5">
                                        {{-- <div class="col-lg-12"> --}}
                                        <form class="row mt-5" action="{{ route('admin.tags.store') }}" method="POST"
                                            ...
                                            <div class="col-lg-4">
                                                <label for="tagSlug" class="label-basic">Slug*</label>
                                                <input type="text" name="slug" id="tagSlug" class="input-basic"
                                                       placeholder="Enter Tag Slug" value="{{ old('slug') }}" required>
                                                @error('slug')
                                                <div style="color: red; font-size: 0.8rem; margin-top: 5px;">
                                                    {{ $message }}</div>
                                                @enderror
