...
class ListingController extends Controller
{
    public function index(): View
    {
        ...
        return view('vendor.listing.index', compact('completedListings', 'pendingListings', 'listings'));
    }
    ...
    public function edit(Listing $listing): View
    {
        ...
        return view('vendor.listing.edit', compact('listing'));
    }
    ...
    public function resumeListing(Listing $listing): RedirectResponse
    {
        ...
        if ($listing->listing_step == 0) {
            return redirect()->route('vendor.listing.index')->with('info', 'That listing is already complete.');
        }
    ...
    protected function redirectToStep($listing): RedirectResponse
    {
        return match ((int)$listing->listing_step) {
            1 => redirect()->route('vendor.listing.address', $listing),
            2 => redirect()->route('vendor.listing.timing', $listing),
            3 => redirect()->route('vendor.listing.amenities', $listing),
            4 => redirect()->route('vendor.listing.logo', $listing),
            default => redirect()->route('vendor.listing.basic-details'),
        };
    }
    ...
    public function create(): View
    {
        ...
        return view('vendor.listing.details');
    }
    ...
    public function editDetails(Listing $listing): View
    {
        ...
        return view('vendor.listing.edit-details', compact('listing'));
    }
    ...
    public function updateDetails(StoreListingRequest $request, Listing $listing): RedirectResponse
    {
        ...
        return redirect()->route('vendor.listing.edit', $listing)->with('success', 'Details saved!');
    }
    ...
    public function store(StoreListingRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('vendor.listing.address', $listing)->with('success', 'Details saved! Now, please add your address.');
    }
    ...
    public function createAddress(Listing $listing): View
    {
        ...
        return view('vendor.listing.address', compact('listing'));
    }
    ...
    public function storeAddress(StoreListingAddressRequest $request, Listing $listing): RedirectResponse
    {
        ...
        return redirect()->route('vendor.listing.timing', $listing)->with('success', 'Address saved successfully! Next, add your hours.');
    }
    ...
    public function editAddress(Listing $listing): View
    {
        ...
        // This is the view for your first form (e.g., business name, description)
        return view('vendor.listing.edit-address', compact('listing'));
    }
...
//        );
    ...
    public function createTiming(Listing $listing): View
    {
        ...
        return view('vendor.listing.timing', [
            'listing' => $listing,
        ]);
    }
    ...
    public function storeTiming(StoreListingTimingsRequest $request, Listing $listing): RedirectResponse
    {
        ...
        return redirect()->route('vendor.listing.amenities', $listing)->with('success', 'Business hours saved!');
    }
    ...
    public function editTiming(Listing $listing): View
    {
        ...
        return view('vendor.listing.edit-timing', compact('listing','timings'));
    }
    ...
    public function updateTiming(StoreListingTimingsRequest $request, Listing $listing): RedirectResponse
    {
        ...
        return redirect()->route('vendor.listing.edit', $listing)->with('success', 'Business hours saved!');
    }
    ...
    public function createAmenities(Listing $listing): View
    {
        ...
        return view('vendor.listing.amenities', [
            'listing' => $listing,
    ...
    public function storeAmenities(StoreListingAmenitiesRequest $request, Listing $listing): RedirectResponse
    {
        ...
        return redirect()->route('vendor.listing.logo', $listing)->with('success', 'Categories and tags saved!');
    }
    ...
    public function editAmenities(Listing $listing): View
    {
        ...
        return view('vendor.listing.edit-amenities', [
            'listing' => $listing,
            'categories' => $categories,
            'tags' => $tags,
        ]);
    ...
    public function updateAmenities(StoreListingAmenitiesRequest $request, Listing $listing): RedirectResponse
    {
        ...
        // 5. Redirect to the next step
        return redirect()->route('vendor.listing.edit', $listing)->with('success', 'Categories and tags saved!');
    }
    ...
    public function createLogo(Listing $listing): View
    {
        ...
        return view('vendor.listing.logo', [
            'listing' => $listing,
        ]);
    }
    ...
    public function storeLogo(StoreListingLogoRequest $request, Listing $listing): RedirectResponse
    {
        ...
        return redirect()->route('vendor.dashboard')->with('success', 'Your listing has been submitted successfully!');
    }
}
